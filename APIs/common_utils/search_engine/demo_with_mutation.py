...
from gmail import provision_new_account
from gmail import search_mailbox_for_emails, dispatch_email
...
def setup_data():
    ...
    provision_new_account(new_user_identifier="me", initial_profile_data={"emailAddress": "me@example.com"})
    ...
    for msg_data in messages:
        msg_data["id"] = dispatch_email(sending_user_id="me", message_to_send=msg_data)["id"]
...
def demo_strategy_comparison():
    ...
    print("=" * 80)
    print("DEMO 1: SIDE-BY-SIDE FOR TYPO QUERY")
    print("=" * 80)
    ...
    result_keyword = search_mailbox_for_emails(user_account_to_search="me", search_query_string=query)
    ...
    result_fuzzy = search_mailbox_for_emails(user_account_to_search="me", search_query_string=query)
    ...
    result_semantic = search_mailbox_for_emails(user_account_to_search="me", search_query_string=query)
    expected_ids = [msg["id"] for msg in DB["users"]["me"]["messages"].values() if msg["subject"] == "Weekly Newsletter"]
...
def demo_semantic_query():
    ...
    print("=" * 80)
    print("DEMO 2: SIDE-BY-SIDE FOR SEMANTIC QUERY")
    print("=" * 80)
...
def demo_fuzzy_cutoff():
    ...
    print("=" * 80)
    print("DEMO 3: FUZZY SEARCH CUTOFF IMPACT")
    print("=" * 80)
    ...
    result_lenient = search_mailbox_for_emails(user_account_to_search="me", search_query_string=query)
    ...
    result_strict = search_mailbox_for_emails(user_account_to_search="me", search_query_string=query)
...
def demo_semantic_threshold():
    ...
    print("=" * 80)
    print("DEMO 4: SEMANTIC SEARCH THRESHOLD IMPACT")
    print("=" * 80)

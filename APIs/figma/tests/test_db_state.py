...
class TestDBState(BaseTestCaseWithErrorHandler):
    ...
    def test_save_and_load_state(self):
        ...
        DB['files'].append({'fileKey': 'test_file', 'name': 'Test File'})
        DB['projects'].append({'projectId': 'test_project', 'name': 'Test Project'})
    ...
    def test_backward_compatibility_loading(self):
        ...
        old_format_db_data = {
            ...
            "projects": [{"projectId": "old_project", "name": "Old Project"}],
        }
        ...
        self.assertEqual(DB['files'], old_format_db_data['files'])
        self.assertEqual(DB['projects'], old_format_db_data['projects'])
        self.assertNotIn('current_file_key', DB)

...
def get_mime_type(file_path: str) -> str:
    ...
    Returns:
        str: The MIME type of the file as a string.
    """
...
def read_file(file_path: str, max_size_mb: int = 50) -> Dict[str, Any]:
    ...
    Args:
        ...
        max_size_mb (int, optional): Maximum file size in MB. Defaults to 50.
        
    Returns:
        Dict[str, Any]: Dict with: content, encoding, mime_type, size_bytes
    """
...
def write_file(file_path: str, content: Union[str, bytes], encoding: str = 'text') -> None:
    ...
    Args:
        ...
        encoding (str, optional): 'text' or 'base64'. Defaults to 'text'.
...
def encode_to_base64(content: Union[str, bytes]) -> str:
    ...
    Args:
        content (Union[str, bytes]): The content to encode (string or bytes).
...
def decode_from_base64(base64_content: str) -> bytes:
    ...
    Args:
        base64_content (str): The base64 encoded string.

...
def read_file(file_path: str, max_size_mb: int = 50) -> Dict[str, Union[str, int]]:
    ...
    Returns:
        Dict[str, Union[str, int]]: A dictionary with content, encoding, mime_type, and size_bytes.

    Raises:
        FileNotFoundError: If the file is not found.
        ValueError: If the file is too large or cannot be decoded.
    """
...
def encode_to_base64(content: Union[str, bytes]) -> str:
    ...
    Args:
        content (Union[str, bytes]): Content to encode.

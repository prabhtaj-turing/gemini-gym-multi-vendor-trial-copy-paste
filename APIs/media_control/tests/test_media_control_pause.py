...
from ..SimulationEngine.custom_errors import NoMediaPlayerError, NoMediaPlayingError, InvalidPlaybackStateError, NoMediaItemError
from .. import pause
...
class TestPause(BaseTestCaseWithErrorHandler):
    ...
    def test_pause_stopped_media(self):
        ...
        self.assert_error_behavior(
            ...
            "Cannot pause media in PlaybackState.STOPPED state"
        )
